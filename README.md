...
> Current deployment docs are below. Older deployment notes later in this file are kept only as historical context and may mention removed `admin-site`, `account-site`, and `dashboard-site` services.

## Current VPS Deploy For d-antes.com

The current production setup uses a single public domain:

- `https://d-antes.com` - public site, blog, login, and authenticated editor.
- `https://d-antes.com/login` - direct editor login.
...
```bash
curl -I https://d-antes.com/login
